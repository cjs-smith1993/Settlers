...
/**
 * Provides the correct ICortex to be used to access the Catan models on the server.
 * Can be programmed to return either the CentralCortex or the MockCortex
 * @author kevinjreece
 */
